  ...
  return (
    <div id="overview-body">
      <div id="overview-body-image">
        ...
        <a onClick={() => expandGallery(true)}>
          <i className="fas fa-expand button-expander"></i>
        </a>
      </div>
      <div className="overview-body-interaction">
        <div className="product-info">
          <div className="current-stars">
            <div className="current-stars-div">
              <Stars total={avgStars} />
            </div>{" "}
            <div
              className="read-all-scroll"
              onClick={() =>
                window.scrollTo({ top: scrollToReviews, behavior: "smooth" })
              }
            >
              read all reviews
            </div>
