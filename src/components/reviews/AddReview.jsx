  ...
  render() {
          ...
          characteristics.push(
            ...
            >
              ...
              <label htmlFor={`${element}-1`}>
                {" "}
                1: {this.state.characteristicLabels[element]["1"]}
              </label>
              <input
                id={`${element}-1`}
                onChange={(event) => {
                  this.handleCharacteristicChange(event, element);
                }}
                type="radio"
                name={element}
                value={1}
              ...
              <label htmlFor={`${element}-2`}>
                2: {this.state.characteristicLabels[element]["2"]}
              </label>
              <input
                id={`${element}-2`}
                onChange={(event) => {
              ...
              <label htmlFor={`${element}-3`}>
                3: {this.state.characteristicLabels[element]["3"]}
              </label>
              <input
                id={`${element}-3`}
                onChange={(event) => {
              ...
              <label htmlFor={`${element}-4`}>
                4: {this.state.characteristicLabels[element]["4"]}
              </label>
              <input
                id={`${element}-4`}
                onChange={(event) => {
              ...
              <label htmlFor={`${element}-5`}>
                5: {this.state.characteristicLabels[element]["5"]}
              </label>
              <input
                id={`${element}-5`}
                onChange={(event) => {
    ...
    return (
      <div className="add-review">
        <button className="add-review-button" onClick={this.handleOpenForm}>
          Write Your Review
        </button>
        <ReactModal
        ...
        >
          ...
          >
            ...
            <input
              ...
              aria-label="Add review summary"
              name="add-review-summary"
              maxLength="60"
              onClick={() => {
                this.clickLogger("set-review-summary", this.props.id);
              }}
            ...
            <div className="body-input">
              ...
              <textarea
                ...
                minLength="50"
                onClick={() => {
                  this.clickLogger("set-review-body", this.props.id);
                }}
            ...
            <div className="photos-input">
              <span htmlFor="add-review-photos">
              ...
              <input
                ...
                name="add-review-photos"
                onChange={this.handlePhoto}
                style={{ display: display, opacity: 0 }}
              />
              {previewPhotos}
            </div>
            ...
            <div className="nickname-input">
              ...
              <br></br>
              <input
                aria-label="Add review nickname"
                id="add-review-nickname"
                name="add-review-nickname"
                maxLength="60"
                type="text"
                value={this.state.nickname}
                onClick={() => {
                  this.clickLogger("set-review-nickname", this.props.id);
                }}
                onChange={this.handleNicknameChange}
                required
              />
              <br></br>
              <span htmlFor="add-review-nickname">
            ...
            <div className="email-input">
              ...
              <br></br>
              <input
                aria-label="Add review email"
                id="add-review-email"
                name="add-review-email"
                maxLength="60"
                type="email"
                value={this.state.email}
                onClick={() => {
                  this.clickLogger("set-review-email", this.props.id);
                }}
                onChange={this.handleEmailChange}
                required
              />
              <br></br>
              <span htmlFor="add-review-email">
