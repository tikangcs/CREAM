    ...
    return (
      <div className="review-characteristic">
        ...
        <div
          ...
          style={{
            width: ((parseInt(this.props.data.value) - 1) / 4) * 100 + "%",
          }}
        ></div>
        <div className="characteristics-labels">
          <p>{this.state[this.props.type][0]}</p>{" "}
          <p>{this.state[this.props.type][1]}</p>{" "}
          <p>{this.state[this.props.type][2]}</p>{" "}
        </div>
      </div>
    );
  }
