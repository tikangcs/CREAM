...
class ReviewTile extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      body2: this.props.review.body.substring(
        251,
        this.props.review.body.length
      ),
    };
  ...
  showMore(event) {
    ...
    if (this.more.current.style.display !== "none") {
      ...
      this.setState({
        body1: this.state.body1.substring(0, this.state.body1.length - 3),
      });
    }
  }
  ...
  render() {
    ...
    var date = `${months[this.state.month]} ${this.state.day}, ${
      this.state.year
    }`;
    ...
    return (
      <div className="review-tile">
        ...
        <div className="review-stars">
          <Stars className="review-stars" total={this.props.review.rating} />
        </div>
        ...
        <p className="review-body">
          {this.state.body1}
          <span className="review-body-more" ref={this.more}>
            {this.state.body2}
          </span>
          {(() => {
            if (this.state.body2.length > 0) {
              return (
                <button className="review-show-more" onClick={this.showMore}>
                  Show More
                </button>
              );
            }
        ...
        {(() => {
          if (this.props.review.recommend) {
            return (
              <p className="review-recommend">This product is recommended!</p>
            );
          }
        })()}
        ...
        <div className="review-actions">
          <p className="review-helpful">
            ...
            <span
              style={{
                color:
                  this.props.helpfulLog[this.props.review.review_id] !==
                  undefined
                    ? "green"
                    : null,
              }}
              onClick={() => {
                if (
                  ...
                  this.props.handleHelpfulLog(this.props.review.review_id);
                  this.clickLogger(
                    "review-helpful",
        ...
        <div className="review-response">{resp}</div>
      </div>
    );
  }
}
